...
public:
    ...
    future<std::set<service::vbc::view_building_target>> get_view_building_coordinator_staging_sstables_targets();
    future<mutation> make_vbc_staging_sstable_mutation(api::timestamp_type ts, locator::host_id host_id, shard_id shard);
    future<mutation> make_vbc_staging_sstable_done_mutation(api::timestamp_type ts, locator::host_id host_id, shard_id shard);
