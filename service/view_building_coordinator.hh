...
class view_building_coordinator : public migration_listener::only_view_notifications {
    struct vbc_state {
        ...
        std::set<view_building_target> targets_with_staging_sstables;
...
private:
    ...
    future<> send_staging_task(view_building_target target, table_id base_id);
    ...
    future<> mark_staging_task_completed(view_building_target target, table_id base_id);
